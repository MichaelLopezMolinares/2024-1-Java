...
/**
 * {@summary} Esta clase se dedica a la ventana para ingresar los datos necesarios de un empleado de clase IngenieroSenior
 */
public class VentanaDatosIngSe extends JFrame{
	...
	/**
	 * Constructor para VentanaDatosIngSe. Inicializa los JLabels y JTextFields necesarios, crea el boton para calcular y añade los atributos
	 */
	public VentanaDatosIngSe () {
		setBounds (10, 10, 1200, 700);
		setTitle("Datos del Ingeniero Senior");
		setResizable(false);
		...
		añoIngreso.setBounds(300, 540, 350, 30);
		...
		vent = new JLabel("Ventas Realizadas: ");
		vent.setBounds(80, 550, 350, 100);
		vent.setForeground(colorVerde);
		vent.setFont(new Font("TimesRoman",Font.LAYOUT_RIGHT_TO_LEFT, 35));
		
		ventas = new JTextField();
		ventas.setBounds(400, 590, 350, 30);
		ventas.setForeground(Color.gray);
		ventas.setFont(new Font("Arial", 0, 20));
